...
class TestWangyi(unittest.TestCase):
    def test_wang(self):
        ...
        # browser.find_element_by_name('email').send_keys('a416437020')
        driver.find_element(By.NAME, "email").send_keys('a416437020')
        # browser.find_element_by_name('password').send_keys('b416437020')
        driver.find_element(By.NAME, 'password').send_keys('b416437020')
